...
const televisionServices = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1593784991095-a205069470b6?w=400&h=300&fit=crop&q=80'
  },
  {
    id: 'tv-installation',
    ...
    bullets: [
      'We will install the TV with care.',
      'We will clean the area once work is done.'
    ],
    image: 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=400&h=300&fit=crop&q=80'
  },
  {
    ...
    bullets: [
      'Safe uninstallation of TV unit and wall bracket removal.',
      'Inspection and repackaging guidance.'
    ],
...
export default function TelevisionPage() {
  ...
  const handleAddToCart = (item) => {
    addToCart({
      ...
      name: item.name,
      price: item.price,
      image: item.image || 'https://images.unsplash.com/photo-1593784991095-a205069470b6?w=400&h=300&fit=crop&q=80',
  ...
  return (
    <div className="bridal-makeup-page-wrapper" style={{ background: '#ffffff', minHeight: '100vh' }}>
      ...
      <main className="bridal-makeup-container" style={{ paddingTop: '32px', paddingBottom: '60px', maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: '320px 1fr 300px', gap: '32px' }}>
        ...
        <aside style={{ display: 'flex', flexDirection: 'column', gap: '20px', position: 'sticky', top: '80px', height: 'fit-content' }}>
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '14px', color: '#64748b', marginBottom: '20px' }}>
              ...
              <strong style={{ color: '#0f172a' }}>4.81</strong>
              <span>(1.2 M bookings)</span>
            </div>
        ...
        {/* MIDDLE CONTENT AREA - Select a service */}
