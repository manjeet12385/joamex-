...
const geyserRepairServices = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1585074245728-eee2d5040d7c?w=400&h=300&fit=crop&q=80'
  },
  {
    id: 'geyser-service',
    name: 'Geyser service',
...
const geyserInstallationServices = [
  {
    ...
    duration: '60 mins',
    bullets: [
      'Complete wall mounting, water inlet/outlet connection & safety test'
    ],
    image: 'https://images.unsplash.com/photo-1585074245728-eee2d5040d7c?w=400&h=300&fit=crop&q=80'
  },
  {
    ...
    duration: '40 mins',
    bullets: [
      'Safe dismounting & water pipe disconnection'
    ],
    image: 'https://images.unsplash.com/photo-1585074245728-eee2d5040d7c?w=400&h=300&fit=crop&q=80'
  }
];
...
export default function GeyserPage() {
  ...
  const handleAddToCart = (item) => {
    addToCart({
      ...
      name: item.name,
      price: item.price,
      image: item.image || 'https://images.unsplash.com/photo-1585074245728-eee2d5040d7c?w=400&h=300&fit=crop&q=80',
      category: 'Geyser Service & Repair'
    });
      ...
      <main className="bridal-makeup-container" style={{ paddingTop: '32px', paddingBottom: '60px', maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: '320px 1fr 300px', gap: '32px' }}>
        ...
        <aside style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div>
            ...
            <button
              onClick={() => {
                const el = document.getElementById('geyser-services-list');
        ...
        {/* MIDDLE CONTENT AREA */}
        <section id="geyser-services-list" style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          
          {/* Section 1: Repair & service */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <h2 style={{ fontSize: '24px', fontWeight: '800', color: '#0f172a', margin: 0 }}>
              Repair & service
            </h2>
            {geyserRepairServices.map(renderServiceCard)}
          </div>

          {/* Section 2: Installation & uninstallation matching user screenshot */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <h2 style={{ fontSize: '24px', fontWeight: '800', color: '#0f172a', margin: 0 }}>
              Installation & uninstallation
            </h2>
            {geyserInstallationServices.map(renderServiceCard)}
          </div>
