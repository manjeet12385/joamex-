...
import { Check, Star, Clock, Shield, ChevronRight, Percent } from 'lucide-react';
import '../services/bridal-makeup/style.css';

const airCoolerServices = [
  {
    id: 'air-cooler-check-up',
  ...
  },
  {
    ...
    bullets: [
      'Descaling of pump & base. Side pad replacement will cost extra.'
    ],
    image: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400&h=300&fit=crop&q=80'
  }
];

export default function AirCoolerPage() {
  ...
  const handleAddToCart = (item) => {
    addToCart({
      ...
      name: item.name,
      price: item.price,
      image: item.image || 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400&h=300&fit=crop&q=80',
      category: 'Air Cooler Service & Repair'
    });
  ...
  return (
    <div className="bridal-makeup-page-wrapper" style={{ background: '#ffffff', minHeight: '100vh' }}>
      ...
      <main className="bridal-makeup-container" style={{ paddingTop: '32px', paddingBottom: '60px', maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: '320px 1fr 300px', gap: '32px' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap', marginBottom: '8px' }}>
              ...
              <div style={{
                ...
                <Clock size={14} color="#047857" /> Earliest Today, 3:00 PM
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '14px', color: '#64748b', marginBottom: '20px' }}>
              ...
              <strong style={{ color: '#0f172a' }}>4.66</strong>
              <span>(213K bookings)</span>
            </div>
            ...
            <button
              onClick={() => {
                const el = document.getElementById('air-cooler-services-list');
        ...
        {/* MIDDLE CONTENT AREA */}
        <section id="air-cooler-services-list" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        {/* RIGHT SIDEBAR - Offer Card & UC Promise & Cart Bar */}
        <aside style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          
          {/* Discount/Offer Card matching Image 2 */}
          <div style={{
            background: '#ffffff',
            border: '1px solid #e2e8f0',
            borderRadius: '16px',
            ...
            <div>
              <h4 style={{ fontSize: '14px', fontWeight: '800', color: '#0f172a', margin: '0 0 2px 0' }}>Get visitation fee off</h4>
              <p style={{ fontSize: '12px', color: '#64748b', margin: 0, fontWeight: '500' }}>On orders above ₹200</p>
            </div>
          </div>
