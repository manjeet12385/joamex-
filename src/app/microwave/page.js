...
const microwaveIssues = [
  ...
  {
    id: 'turntable-not-rotating',
    name: 'Turntable not rotating',
    rating: '4.86',
    reviews: '20K reviews',
    price: 199,
  }
...
const microwaveServices = [
  {
    id: 'microwave-check-up',
    name: 'Microwave check-up',
    rating: '4.83',
    reviews: '61K',
    ...
    bullets: [
      'Detailed inspection of magnetron, fuse, touch panel, transformer & turntable motor',
      'Repair quote provided after complete diagnosis'
    ],
    image: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=400&h=300&fit=crop&q=80'
  },
  {
    id: 'microwave-repair-servicing',
    name: 'Microwave repair & servicing',
    rating: '4.86',
    reviews: '120K',
    pricePrefix: 'Starts at ',
    price: 399,
    ...
    bullets: [
      'Fixing heating issues, sparking, touch panel or turntable motor failure',
      'Genuine spare parts & 30-day repair warranty'
    ],
    image: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=400&h=300&fit=crop&q=80'
  },
  {
    id: 'microwave-deep-cleaning',
    ...
    duration: '30 mins',
    bullets: [
      'Steam cleaning & degreasing of interior cavity, turntable plate & door seal',
      'Food stain & odour removal using eco-friendly agents'
    ],
    image: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=400&h=300&fit=crop&q=80'
  }
];
  ...
  return (
    <div className="bridal-makeup-page-wrapper" style={{ background: '#ffffff', minHeight: '100vh' }}>
      ...
      <main className="bridal-makeup-container" style={{ paddingTop: '32px', paddingBottom: '60px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '360px 1fr', gap: '32px', marginBottom: '40px', alignItems: 'center' }}>
          ...
          <div>
            ...
            <div style={{
              ...
              <span style={{ color: '#22c55e', fontWeight: '800' }}>✓ UC COVER</span>
              <span style={{ color: '#64748b' }}>Verified quotes & upto 180 days warranty ›</span>
            </div>

            {/* Main Heading & Instant Badge */}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '14px', color: '#64748b', marginBottom: '24px' }}>
              ...
              <span>(793K bookings)</span>
            </div>

            {/* View Services Purple Button */}
            <button
              onClick={() => {
                const el = document.getElementById('microwave-services-list');
          ...
          <div style={{
            ...
            <img
              ...
              alt="Technician testing microwave oven"
        ...
        <div id="microwave-services-list" style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '32px' }}>
          ...
          <section style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            {/* QUICK ISSUE CAROUSEL ROW (Matching User Image) */}
            <div style={{ position: 'relative', marginBottom: '8px' }}>
              <div
                id="issues-scroll-container"
                style={{
                  display: 'flex',
                  gap: '14px',
                  overflowX: 'auto',
                  ...
                  >
                    <div>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '12px', color: '#64748b', marginBottom: '10px' }}>
                        ...
                        <span>{issue.rating} ({issue.reviews})</span>
                      </div>
                    ...
                    {getItemQuantity(issue.id) > 0 ? (
                      <div style={{
                        ...
                        <button
                          onClick={() => updateQuantity(issue.id, getItemQuantity(issue.id) - 1)}
                          style={{ background: 'none', border: 'none', color: '#6c5ce7', fontSize: '15px', fontWeight: '800', cursor: 'pointer', padding: 0 }}
                        >
                          -
                        </button>
                        <span style={{ fontSize: '13px', color: '#6c5ce7', fontWeight: '800' }}>{getItemQuantity(issue.id)}</span>
                        <button
              ...
              <button
                onClick={() => {
                  const container = document.getElementById('issues-scroll-container');
